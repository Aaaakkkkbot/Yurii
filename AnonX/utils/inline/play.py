...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="🔕 𝗖𝗵𝗮𝘁 𝗚𝗿𝗼𝘂𝗽🏋️‍♀️", url="https://t.me/YurriSupport"
            ),
        ],
        [
            InlineKeyboardButton(
...
def telegram_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="🏵️ 𝗖𝗵𝗮𝘁 𝗚𝗿𝗼𝘂𝗽🌺", url="https://t.me/YurriSupport"
            ),
        ],
        [
            InlineKeyboardButton(
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="𝗖𝗵𝗮𝘁 𝗚𝗿𝗼𝘂𝗽➡️", url="https://t.me/YurriSupport"
            ),
        ],
        [
            InlineKeyboardButton(
...
def telegram_markup(_, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="⏮️ 𝗖𝗵𝗮𝘁 𝗚𝗿𝗼𝘂𝗽▶️", url="https://t.me/YurriSupport"
            ),
        ],
        [
            InlineKeyboardButton(
...
def queue_markup(_, videoid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="🍷 𝗖𝗵𝗮𝘁 𝗚𝗿𝗼𝘂𝗽🍷", url="https://t.me/YurriSupport"
            ),
        ],
        [
            InlineKeyboardButton(
